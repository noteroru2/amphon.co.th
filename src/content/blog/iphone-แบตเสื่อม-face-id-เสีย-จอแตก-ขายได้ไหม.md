---
title: "iPhone แบตเสื่อม Face ID เสีย จอแตก ยังขายได้ไหม"
slug: "iphone-แบตเสื่อม-face-id-เสีย-จอแตก-ขายได้ไหม"
...
สถานการณ์ที่พบบ่อยคือ เครื่องยังใช้งานได้แต่แบตเสื่อม Face ID ไม่ติด จอมีรอย หรือฝาหลังแตก ทำให้กังวลว่าจะถูกกดราคามากเกินไป ซึ่งเป็นเรื่องปกติมากในสินค้ามือสอง สิ่งสำคัญไม่ใช่การทำให้สินค้าดูสมบูรณ์เกินจริง แต่คือการรู้จุดแข็ง จุดอ่อน และเตรียมข้อมูลให้ครบ เพื่อให้ร้านประเมินได้ใกล้เคียงราคาจริงที่สุด
...
สำหรับ iPhone จุดที่ควรดูเป็นพิเศษคือ ตรวจ Battery Health, Face ID, True Tone, กล้อง, ลำโพง, ไมค์, พอร์ตชาร์จ และสถานะ iCloud เพราะเป็นข้อมูลที่ช่วยให้ประเมินราคาได้แม่นขึ้น หากส่งข้อมูลไม่ครบ ร้านมักต้องถามเพิ่มหลายรอบ ทำให้เสียเวลาและอาจได้ราคาเบื้องต้นกว้างเกินไป
...
สำหรับ iPhone มีรายละเอียดเฉพาะที่ควรเช็กเพิ่ม เพราะเป็นจุดที่ทำให้ราคาต่างกันได้มาก แม้สินค้าจะเป็นรุ่นเดียวกันก็ตาม จุดสำคัญคือ ตรวจ Battery Health, Face ID, True Tone, กล้อง, ลำโพง, ไมค์, พอร์ตชาร์จ และสถานะ iCloud

เทคนิคที่แนะนำคือ

- ถ่ายหน้า Battery Health ให้ชัด
- ถ่ายตำหนิจอและฝาหลังแบบไม่เปิดแฟลชแรงเกินไป
- ออกจาก iCloud ได้ก่อนตกลงขาย
