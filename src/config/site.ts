export const site = {
  ...
  title: 'Amphon.co.th',
  description:
    'อำพล เทรดดิ้ง รับซื้อโน๊ตบุ๊ค คอม iPhone iPad MacBook กล้อง และอุปกรณ์ไอทีทั่วประเทศ ส่งรูปเช็กราคาเบื้องต้นได้ มีหน้าร้านจริงที่อุบลราชธานี',
