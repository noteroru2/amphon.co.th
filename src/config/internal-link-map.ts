...
export const SERVICE_SUPPORTING_ARTICLES: Record<string, SupportingArticleLink[]> = {
  ...
  'รับซื้อแรม': [
    {
      path: '/blog/แรมมือสองขายได้เท่าไหร่',
      anchor: 'แรมมือสองขายได้เท่าไหร่และประเมินจากอะไร',
    },
    {
      path: '/blog/วิธีเช็กสเปกคอมก่อนขาย',
  ...
  'รับซื้อคอมพิวเตอร์': [
    ...
    {
      path: '/blog/คอมเกมมิ่งมือสอง-ขายอย่างไรให้ได้ราคาดี',
      anchor: 'เตรียมข้อมูล Gaming PC ก่อนส่งประเมิน',
    },
    {
      path: '/blog/ถ่ายรูปสินค้าไอทีให้ร้านประเมินราคาเร็ว',
      anchor: 'ถ่ายรูปคอมอย่างไรให้ประเมินได้เร็ว',
    },
  ],
  'รับซื้อแท็บเล็ต': [
    {
      path: '/blog/surface-เปิดไม่ติด-จอแตก-คีย์บอร์ดเสีย-ขายได้ไหม',
      anchor: 'Surface มีตำหนิแล้วยังประเมินได้ไหม',
    },
    {
      path: '/blog/ถ่ายรูปสินค้าไอทีให้ร้านประเมินราคาเร็ว',
      anchor: 'ถ่ายรูปแท็บเล็ตอย่างไรให้ประเมินได้เร็ว',
    },
    {
      path: '/blog/กล่องใบเสร็จอุปกรณ์ครบ-มีผลต่อราคาขายไหม',
      anchor: 'กล่อง ปากกา และอุปกรณ์มีผลต่อราคาอย่างไร',
    },
  ],
  'รับซื้อ-ipad': [
    {
