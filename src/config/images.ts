...
export const imageAlt: Record<string, string> = {
  ...
  '/images/b2b/buy-server-network.webp':
    'Server และอุปกรณ์ Network มือสองสำหรับหน้าบริการรับซื้อ Server และ Network',
};

export function getImageAlt(src: string, fallback = ''): string {
  return imageAlt[src] ?? fallback;
}

// ---------------------------------------------------------------------------
// Image-to-content mapping (verified as of 30 May 2026)
// ---------------------------------------------------------------------------
// rub-sue-iphone-amphon-trading-banner    → iPhone service banner  ✓
// rub-sue-iphone-tur-ruen-rap-raka-sung   → tablet/iPad device photo (used for iPad) ✓
// rub-sue-macbook-amphon-trading-banner   → MacBook banner ✓
// rub-sue-notebook-laptops-acer-asus      → Acer Nitro + ASUS gaming laptops ✓
// rub-sue-komputer-gaming-pc-amphon       → Gaming PC (Gigabyte GPU) — NEW 30 May 2026 ✓
// rub-sue-khong-fujifilm-x-a2-amphon      → Fujifilm X-A2 + lenses — NEW 30 May 2026 ✓
// hero-amphon-showroom-rub-sue-it-isan    → professional showroom with all product types ✓
// ---------------------------------------------------------------------------

/** Thumbnails for homepage category grid */
export const categoryImages: Record<string, { src: string; alt: string }> = {
  ...
  '/บริการ/รับซื้อ-macbook': {
    ...
    alt: imageAlt['/images/services/rub-sue-macbook-amphon-trading-banner.webp'],
  },
  '/บริการ/รับซื้อโน๊ตบุ๊ค': {
    src: '/images/services/rub-sue-notebook-laptops-acer-asus.webp',
